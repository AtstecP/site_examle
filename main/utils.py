...
"""
Нужно отрефакторить этот код 
"""



#это оосбонеено требует рефакторинга
...
def get_vacancies():
    try:
        params = {
            'text': 'Python', #Тут название твоей професии
            'specialization': 1,
            'page': 1,
            'per_page': 100,
            'date_from': f'2022-12-12T00:00:00+0300', #дат за которую собирать
            'date_to': f'2022-12-13T00:00:00+0300',
        }
        data = []
